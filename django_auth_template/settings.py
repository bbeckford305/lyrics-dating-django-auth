"""
Django settings for lyric-dating-django-auth project.
...
ROOT_URLCONF = 'lyric-dating-django-auth.urls'
...
WSGI_APPLICATION = 'lyric-dating-django-auth.wsgi.application'
