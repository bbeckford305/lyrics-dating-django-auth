...
This template contains a project, `lyric-dating-django-auth`, and an app, `api`,
...
1. Replace all instances of `lyric-dating-django-auth` with your application name. **This includes the folder included in this repository.**
...
This template includes a project `lyric-dating-django-auth` which should be renamed
...
all instances of `lyric-dating-django-auth` with your app's name.
